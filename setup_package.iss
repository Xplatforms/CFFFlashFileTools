...
#define MyAppName "CFFFlashFileTools"
#define MyAppNameUninstall "CFFFlashFileTools"
#define MyAppFolderName "CFFFlashFileTools"
#define MyAppVersion "0.0.001a"
#define MyAppPublisher "Xplatforms"
#define MyAppURL "https://github.com/Xplatforms/CFFFlashFileTools/releases"
#define MyAppExeName "CFFFlashFileTools.exe"
...
AppId={{0DE3DC29-300C-478C-8DA4-4F5EE741C2EB}}
...
AppSupportURL="https://github.com/Xplatforms/CFFFlashFileTools"
...
LicenseFile=LICENSE
OutputDir=..\BUILDS\
OutputBaseFilename=CFFFlashFileTools_x64_{#MyAppVersion}
...
[Files]
Source: "..\BUILDS\CFFFlashFileTools\*"; DestDir: "{app}"; Flags: ignoreversion overwritereadonly replacesameversion recursesubdirs
